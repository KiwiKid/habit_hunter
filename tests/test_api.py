"""Tests for Habit Hunter api."""
import asyncio

import aiohttp
from custom_components.habit_hunter.api import (
    HabitHunterApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = HabitHunterApiClient("test", "test", async_get_clientsession(hass))
