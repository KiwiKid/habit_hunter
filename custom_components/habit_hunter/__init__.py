...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    coordinator = HabitHunterDataUpdateCoordinator(hass, client=client)
...
class HabitHunterDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    def __init__(
        self,
        hass: HomeAssistant,
        client: HabitHunterApiClient,
    ) -> None:
        """Initialize."""
        self.api = client
        self.platforms = []
